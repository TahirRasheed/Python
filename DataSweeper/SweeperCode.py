...
st.markdown(
    ...
    <style>
        .main {
            background-color:   rgb(196, 181, 181);  /* Overall dark background for the main page */
        }
        .block-container {
            padding: 3rem 2rem;  /* Padding around main container for spacing */
            border-radius: 12px;  /* Rounds the corners of the container */
            background-color:rgb(184, 197, 177);  /* Slightly lighter shade for contrast */
            box-shadow: 0 4px 15px rgba(8, 31, 134, 0.3);  /* Adds subtle shadow for depth */
        }
        h1, h2, h3, h4, h5, h6 {
            color:rgb(2, 95, 44);  /* Light blue color for headings to stand out */
        }
        .stButton>button {
            border: none;
...
st.title("Data Sweeper Assignment")  # Large, eye-catching title
